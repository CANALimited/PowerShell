<#	
	...
	===========================================================================
	 ...
	 Created on:   	04/04/2019 1:44 PM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergySupervisorCivil.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergySupervisorCivil 
...
function Add-EnergySupervisorCivil
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergySupervisorCivil $Username
...
#>	
	...
	$ADGroups.add('SW_Bluebeam_Ext_Users') | Out-Null
