<#	
	...
	===========================================================================
	 ...
	 Created on:   	04/04/2019 10:26 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyEstimatingContractsAdmin.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyEstimatingContractsAdmin 
...
function Add-EnergyEstimatingContractsAdmin
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyEstimatingContractsAdmin $Username
