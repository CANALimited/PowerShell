<#	
	...
	===========================================================================
	 ...
	 Created on:   	04/04/2019 10:02 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyENGPrinciple.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyENGPrinciple
...
function Add-EnergyENGPrinciple
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyENGPrinciple $Username
